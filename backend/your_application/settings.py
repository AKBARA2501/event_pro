...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-_1@q$e#@_4dmj)_kf=q2_cyz#zryg7_k)3qir30+-r3f8w_zhh')
...
ROOT_URLCONF = 'your_application.urls'
...
WSGI_APPLICATION = 'your_application.wsgi.application'
